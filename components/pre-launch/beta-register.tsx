...
export function BetaRegister() {
    ...
    try {
      ...
      if (result.success) {
        toast({
          ...
          description: "Thank you for registering the Collabo beta!",
        })
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#EFE7F7]">
      <div className="max-w-md w-full mx-auto bg-white p-8 rounded-3xl shadow-lg">
        <h2 className="text-3xl font-bold mb-6 text-center text-purple-600">Register for Collabo</h2>
        <Form {...form}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      placeholder="Tell us what features you'd like to see in Collabo!"
